...
# === main ===
def main():
    inputseq = "https://ftp.ncbi.nlm.nih.gov/genomes/all/GCF/018/350/175/GCF_018350175.1_F.catus_Fca126_mat1.0/GCF_018350175.1_F.catus_Fca126_mat1.0_genomic.fna.gz"
    inputfile = "input.fna.gz" #i know not all inputs are going to be a .gz so if we can improve on how to fix it that would be great
